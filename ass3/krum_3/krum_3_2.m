%Spencer Krum
%April 21, 2011
%PH 322 problem 3_2 which is actually 2_18


%Text of the Problem:

%Calculate the effect of backspin on a fastball. How much does an angular velocity of 1000rpm(typical for a fastball) affect the trajectory?

%General plan of solution:
%   1) Construct working Baseball fasball pitching simulator. 
%   2) Add in spin and angular momentum by reading section 2.4 
